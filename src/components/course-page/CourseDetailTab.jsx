...
import {Card, Tab, Container, Tabs, ListGroup, Badge, Button} from 'react-bootstrap';
...
function CourseDetailTab({course, isAdmin, isTeacher, isMainTeacher, isStudent, setSavedCourse}) {
  ...
  return (
    <div className="mt-5" border="light">
        ...
        <NotificationCreateModal show={showCreateNotificationModal} onClose={toggleNotificationCreateModal}
            handleSubmit={handleNotificationCreateSubmit} validated={notificationCreateValidated}/>
    </div>
  );
}
